...
class TextStyles {
  ...
  static TextStyle listExtra =
      TextStyle(fontSize: Dimens.font_sp12, color: AppColors.text_gray);
  static TextStyle listExtra2 =
      TextStyle(fontSize: Dimens.font_sp12, color: AppColors.text_normal);
}
